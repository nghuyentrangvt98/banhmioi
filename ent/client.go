...
// QueryCart queries the cart edge of a Order.
func (c *OrderClient) QueryCart(o *Order) *CartQuery {
...
type (
	hooks struct {
		Cart, News, Order, Product, User []ent.Hook
	}
	inters struct {
		Cart, News, Order, Product, User []ent.Interceptor
	}
)
